...
[ screenshot of menu with “Welcome to VRUniverse”]
...
All planets now have a scene that shows some part of their molecular makeup! The inner planets were fairly straightforward, with their cores being mostly comprised of heavy metals like iron and nickel in either a solid or molten form. The molecules scenes were more difficult to implement for the outer planets (Jupiter - Neptune + Pluto) due to the much lower knowledge base we have about these planets.
...
[Interior of the sun with text pic]
...
[interior of mercury with text pic]
...
[interior of uranus with text pic]
...
[interior of neptune with text pic]
