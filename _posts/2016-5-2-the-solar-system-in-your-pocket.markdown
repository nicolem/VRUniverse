...
<div style="text-align: center"><img src="{{ '/assets/img/blog2/mars2d.png' | prepend: site.baseurl }}" alt="" style="width:60%"></div>
...
<div style="text-align: center"><img src="{{ '/assets/img/blog2/saturn2d.png' | prepend: site.baseurl }}" alt="" style="width:60%"></div>
...
<div style="text-align: center"><img src="{{ '/assets/img/blog2/settings2d.png' | prepend: site.baseurl }}" alt="" style="width:60%"></div>
